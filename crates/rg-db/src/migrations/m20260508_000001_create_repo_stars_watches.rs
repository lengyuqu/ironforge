        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .index(Index::create().unique().col(RepoStars::UserId).col(RepoStars::RepoId).name("idx_repo_stars_user_repo_unique"))
                    .index(Index::create().col(RepoStars::RepoId).name("idx_repo_stars_repo_id"))
                    .foreign_key(
                        ForeignKey::create()
