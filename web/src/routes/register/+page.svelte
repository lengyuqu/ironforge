<script lang="ts">
  import { register, getAuthError, getAuthLoading } from '$lib/stores/auth';
  ...
  async function handleSubmit(e: Event) {
    ...
    if (ok) {
      ...
      localError = getAuthError() || 'Registration failed';
    }
  }
</script>
  ...
  <div class="login-card">
    ...
    <form onsubmit={handleSubmit}>
      ...
      <button type="submit" class="btn-primary" disabled={getAuthLoading()}>
        {getAuthLoading() ? 'Creating account...' : 'Create account'}
      </button>
    </form>
